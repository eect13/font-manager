...
test("toast Cancel while docs-owned uses docs Name/id via cancelChromeA11y", () => {
  assert.match(toastAction, /cancelChromeA11y/);
  assert.match(toastAction, /showDocsCancelIdentity:\s*true/);
  ...
  // Must not leave plain ambiguous Action { label: "Cancel" } on docs refresh toast
